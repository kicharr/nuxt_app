  ...
  <div class="form-wrapper container">
    <form class="auth-form">
      ...
      <div class="auth-form__inputs">
        <input class="input input__auth input__login" type="text" placeholder="Enter First Name">
        <input class="input input__auth input__password" type="text"
               placeholder="Enter Last Name">
        <input class="input input__auth input__login" type="text" placeholder="Enter your Email">
        <input class="input input__auth input__password" type="text"
               placeholder="Enter your Password">
      </div>

      <div class="auth-form__buttons">
        <button class="btn btn__auth" type="submit">Sign Up</button>
        <NuxtLink to="/authorization" class="btn btn__sign">Login</NuxtLink>
